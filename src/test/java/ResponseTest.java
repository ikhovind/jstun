...
public class ResponseTest {
    ...
    String bindingResponse1 = "010100182112a442717161572f414c47" +
    ...
    public void insertUnknownAttributes() {
        ...
        assertEquals(24 + unknownAttributes.length * 2 +
                (unknownAttributes.length % 2 == 0 ? 0 : 2),
                byteResponse.length);
    ...
    public void validByteResponse() {
        ...
        assertArrayEquals(Helper.hexStringToByteArray(bindingResponse1), validResponse.getByteResponse());
    }
    @Test
    public void invalidByteResponse(){
        ...
        for(int i = 4; i < errorResponse.getByteResponse().length; i++){
            assertEquals(Helper.hexStringToByteArray(bindingResponse1)[i], errorResponse.getByteResponse()[i]);
        }
        ...
        System.arraycopy(errorResponse.getByteResponse(), 72 - 44, stringBytes, 0, errorResponse.getByteResponse().length -(72-44));
